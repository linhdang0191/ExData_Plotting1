...
# set the par. We need it to be set as (2 rows, 2 columns)
...
#Add the legends. I set cex = 0.5 so that the legend does not take up too much area
legend('topright', col = c('black', 'red','blue'), legend = c('Sub_metering_1', 'Sub_metering_2',
                                                              'Sub_metering_3'), lwd = 1, cex = 0.5, bty ='n')
# datetime(Time), Global Reactive Power
